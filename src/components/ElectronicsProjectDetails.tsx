...
const electronicsProjectData: Record<string, ElectronicsProjectData> = {
  "rfid-music-player": {
    ...
    description:
      "An IoT music system that bridges physical interaction with digital streaming. Built with a Raspberry Pi and RFID RC522 reader, this project has helped me gain experience in API integration, and creating user-friendly IoT applications that merge hardware and software seamlessly.",
    hardware: ["Raspberry Pi 4", "RFID RC522 Reader", "Speakers/Audio Output"],
    software: [
      "Python",
      "Spotify Web API",
      "Spotipy Library",
    ...
    images: [],
    challenges: [
      "Implementing OAuth 2.0 to get Permissions",
