...
const projectData: Record<string, ProjectData> = {
  ...
  "pharmacy-sales": {
    ...
    features: [
      "Sales trend analysis across multiple time periods",
    ...
    images: [],
    githubUrl: "https://github.com/mdsingh2002/Pharmacy-Sales-Data",
    challenges: [
      "Cleaning and preprocessing inconsistent sales data",
      "Handling missing values and outliers in the dataset",
      "Identifying meaningful patterns in large datasets",
      "Creating clear visualizations for complex data relationships",
    ],
    learnings: [
      "Advanced data manipulation techniques using Pandas",
      "Statistical analysis methods for business intelligence",
      "Data visualization best practices for presenting insights",
      "How to derive actionable business insights from raw data",
    ],
  },
  "fire-response": {
    title: "Edmonton Emergency Fire Response Analytics",
    subtitle: "Analyzing Emergency Response Patterns and Efficiency",
    description:
      "An in-depth analytical study of emergency fire response data in Edmonton, Alberta. This project analyzes response times, incident patterns, resource allocation, and geographic distribution of fire emergencies to identify areas for improvement in emergency services. By examining historical data with PostgreSQL database integration and data quality validation frameworks, the analysis reveals insights into peak incident times, response efficiency across different neighborhoods, and resource utilization patterns that can help optimize emergency response strategies.",
    technologies: [
      "Python",
      "Pandas",
      "NumPy",
    ...
    features: [
      "Response time analysis by district and time period",
      "Geographic visualization of incident locations",
      "Incident type classification and frequency analysis",
      ...
      "Statistical correlation between response times and outcomes",
      "Interactive maps and heatmaps for spatial analysis",
    ],
    images: [],
    githubUrl:
      "https://github.com/mdsingh2002/Emergency-Fire-Response-Edmonton-Analytics",
    challenges: [
      "Processing and standardizing large volumes of emergency response data",
      "Handling geographic coordinates and mapping data",
      "Accounting for external factors affecting response times",
      "Presenting complex analytical findings in an accessible format",
    ],
    learnings: [
      "Geospatial data analysis and visualization techniques",
      "Time-series analysis for identifying temporal patterns",
      "How to extract meaningful insights from public safety data",
      "Data storytelling techniques for communicating findings",
    ],
  },
};
